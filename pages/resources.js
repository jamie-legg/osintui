import { DatabaseIcon, FilterIcon, HeartIcon, InformationCircleIcon, MapIcon, SearchCircleIcon, ViewListIcon } from "@heroicons/react/outline";
                ...
                {letters.map((letter) => (
                    <div key={letter} className="relative">
                        <div className="code z-10 sticky top-0 px-6 py-1 text-sm font-medium text-gray-700 dark:text-gray-200">
                            <h3>#RES-D:{operationIndex}_{letter}</h3>
                        </div>
